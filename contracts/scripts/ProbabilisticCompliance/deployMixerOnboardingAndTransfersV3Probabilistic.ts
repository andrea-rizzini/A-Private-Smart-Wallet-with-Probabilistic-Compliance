...
async function main () {
    ...
    const mixer = await hre.ethers.getContractFactory("contracts/src/ProbabilisticCompliance/MixerOnboardingAndTransfersV3Probabilistic.sol:MixerOnboardingAndTransfers", faucet);
