...
async function main() {
    ...
    const AccountFactory = await hre.ethers.getContractFactory("contracts/src/ProbabilisticCompliance/Authority.sol:AccountFactory"); 
    ...
    const _authority = await hre.ethers.getContractAt("contracts/src/ProbabilisticCompliance/Authority.sol:Authority", authority);
