...
npx circom -v -r artifacts/circuits/mask_commitment.r1cs -w artifacts/circuits/mask_commitment.wasm -s artifacts/circuits/mask_commitment.sym probabilistic_compliance/mask_commitment.circom
...
npx circom -v -r artifacts/circuits/non_membership_bloom.r1cs -w artifacts/circuits/non_membership_bloom.wasm -s artifacts/circuits/non_membership_bloom.sym probabilistic_compliance/non_membership_bloom.circom
